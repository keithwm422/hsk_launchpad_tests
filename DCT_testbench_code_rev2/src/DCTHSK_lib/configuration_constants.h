//**********************************************************************************************************
// -- Thermistors CS and SCK or port--
//**********************************************************************************************************/
//PORT 3
//const unsigned long TM4CSPI_clock = 23 ; //usually denoted sck
//const unsigned long CHIP_SELECT = 24; //usually denoted cs

//TM4C123GXL SPI PORT 0:
const unsigned long TM4CSPI_clock = 11 ; //usually denoted sck
const unsigned long CHIP_SELECT_A = 7; //usually denoted cs
const unsigned long CHIP_SELECT_B = 14;
const unsigned long CHIP_SELECT_C = 31;
const unsigned long CHIP_SELECT_D = 36;
const unsigned long CHIP_SELECT_E = 12;
/* 5 thermistor chip selects:
CS-A | pin 7
CS-B | pin 14
CS-C | pin 31
CS-D | pin 36
CS-E | pin 12
// These are the thermistors corresponding LTC2983 ICs.
Using chip selects allows them to share the same SPI port and all their addresses to be the same.
Minimizes the amount of code with addressing thats needs to be written. 
*/
