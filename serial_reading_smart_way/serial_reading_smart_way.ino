char buffer[64]; // this for the character sent by a serial device. 
int buffer_iter=0;
int buff; // this is for serial reading
bool is_high=true;
bool is_high_2=true;
int LED_PIN=38;
int LED_PIN_2=39;
...
void loop() {
  ...
  if(buff!=-1) {
    ...
    buffer[buffer_iter]=(char) buff;
    buffer_iter++;
    if(buffer_iter >=64) buffer_iter=0;
